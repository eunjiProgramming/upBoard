...
public class BoardDaoImplTest {
    ...
    public void insertTestData() throws Exception {
        ...
        for(int i = 1; i <= 35; i++) {
            BoardDto boardDto = new BoardDto("빅토리아는 건강해요"+i, "빅토리아가 아주 건강하네요!! 그리고 이뻐요", "eunji");
            boardDao.insert(boardDto);
        }

        for(int i = 1; i <= 35; i++) {
            BoardDto boardDto = new BoardDto("운명이는 건강해요"+i, "운명이가 아주 건강하네요!! 그리고 잘생겼어요", "eunji");
            boardDao.insert(boardDto);
        }

        for(int i = 1; i <= 35; i++) {
            BoardDto boardDto = new BoardDto("복덩이는 건강해요"+i, "복덩이가 아주 건강하네요!! 그리고 이뻐요", "eunji");
            boardDao.insert(boardDto);
        }

        for(int i = 1; i <= 35; i++) {
            BoardDto boardDto = new BoardDto("동이는 건강해요"+i, "동이가 아주 건강하네요!! 그리고 이뻐요", "eunji");
            boardDao.insert(boardDto);
        }

        for(int i = 1; i <= 35; i++) {
            BoardDto boardDto = new BoardDto("서는 건강해요"+i, "서가 아주 건강하네요!! 그리고 이뻐요", "eunji");
            boardDao.insert(boardDto);
        }
